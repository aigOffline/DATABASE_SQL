...
firstname, last_name and full_name that combines the last_name and first_name columns.
...
SELECT firstname, last_name, CONCAT(last_name, ", ", firstname) AS full_name
FROM customers
WHERE last_name >= "M"
...
item_total	A column that’s calculated by subtracting the discount amount from the item 
